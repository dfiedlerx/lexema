...
public class LexerAluno {
            ...
            switch (estado) {
                ...
                case 16:
                    if (Character.isLetterOrDigit(c) || c == '_') {
                        ...
                        if (token != null) {
                            ...
                            return new Token(Tag.RELOP_ASSIGN, lexema.toString(), n_line, n_column);
                ...
                case 23:
                    ...
                    if (c == '"') {
                        ...
                        sinalizaErro("String deve ser fechada com '\"' antes do fim da linha");
                ...
                case 31:
                    if(c != '\r' && c != '\n'){
                        ...
                        return new Token(Tag.ONE_LINE_COMMENT,lexema.toString(), n_line, n_column);
                    }
                    break;
                ...
                case 33:
                    ...
                    if(c == '/'){
                        ...
                        lexema.append(c);
                        return new Token(Tag.MULTIPLES_LINES_COMMENT,lexema.toString(),n_line,n_column);
    ...
    public static void main(String[] args) {
        LexerAluno lexer = new LexerAluno(System.getProperty("user.dir") + "\\src\\lexeraluno\\HelloJavinha.jvn"); // parametro eh um programa em Javinha
        Token token;
